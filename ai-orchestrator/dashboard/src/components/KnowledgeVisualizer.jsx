    ...
    return (
        <div className="bg-slate-800 p-4 rounded-lg border border-slate-700 mb-6 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-3 relative z-10">
                ...
                <div>
                    <h3 className="text-lg font-semibold text-slate-200">{t('knowledge.title')}</h3>
                    <p className="text-xs text-slate-400">
                        {isRecent ? t('knowledge.retrieving') : t('knowledge.monitoring')}
                    </p>
                </div>
            </div>
            ...
            {lastRetrieval && (
                <div className="mt-3 p-3 bg-slate-900/50 rounded border border-slate-700 text-xs font-mono text-slate-300 relative z-10">
                    <div className="flex justify-between items-center mb-1">
                        <span className="text-purple-400 font-bold">{t('knowledge.query')}</span>
                    ...
                    <div className="text-blue-400 font-bold mb-1">{t('knowledge.retrieved')}</div>
